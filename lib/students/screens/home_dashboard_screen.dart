...
class HomeDashboardScreen extends StatefulWidget {
  // Removed the 'onNavigate' callback as we use GoRouter now
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  GridView.count(
                    ...
                    children: [
                      _buildFeatureCard(
                        ...
                        AppColors.primary,
                        () => context.go('/subjects'), // UPDATED path
                      ),
                      _buildFeatureCard(
                        'My Modules',
                        'Continue learning',
                        Icons.description,
                        AppColors.purple,
                        () => context.go('/modules'), // UPDATED path
                      ),
                      _buildFeatureCard(
                        'Virtual Worlds',
                        ...
                        Icons.public,
                        AppColors.cyan,
                        () => context.go('/vr-entry'), // UPDATED path
                      ),
                      _buildFeatureCard(
                        'My Grades',
                        'Track your progress',
                        Icons.emoji_events,
                        AppColors.orange,
                        () => context.go('/grades'), // UPDATED path
                      ),
                    ],
                  ),
                  ...
                  const SizedBox(height: 16),
                  // ... Keep existing Continue Learning Container code ...
                  Container(
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
